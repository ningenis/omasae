...
<div class="header navbar navbar-inverse navbar-fixed-top">
	...
	<div class="header-inner">
	 ...
	 <img src="{{ url('assets/img/logo-omasae.png') }}" alt="logo" class="img-responsive" />
	 </a>
	 <!-- END LOGO -->
				...
				<li>
				 <ul class="dropdown-menu-list scroller" style="height: 250px;">
					<li>  
						 ...
						 <span class="photo"><img src="{{url ('assets/img/avatar2.jpg') }}" alt=""/></span>
						 <span class="subject">
					...
					<li>  
						 <a href="inbox.html?a=view">
						 <span class="photo"><img src="{{url ('assets/img/avatar3.jpg') }}" alt=""/></span>
						 <span class="subject">
					...
					<li>  
						 <a href="inbox.html?a=view">
						 <span class="photo"><img src="{{ url('./assets/img/avatar1.jpg') }}" alt=""/></span>
						 <span class="subject">
